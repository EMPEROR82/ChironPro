...
class tlangVisitor(ParseTreeVisitor):
    ...
    def visitPrintList(self, ctx:tlangParser.PrintListContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by tlangParser#expoExpr.
    ...
    def visitExponentiative(self, ctx:tlangParser.ExponentiativeContext):
        return self.visitChildren(ctx)
