...
if __name__ == "__main__":
    ...
    cmdparser.add_argument(
        ...
        default="green",
        type=str,
        help="Set the color of the turtle"
    )
    cmdparser.add_argument(
        "-bc",
        "--background_color",
    ...
    cmdparser.add_argument(
        ...
        default="blue",
        type=str,
        help="Set the color of the line"
    )

    cmdparser.add_argument(
        "--headless",
        action="store_true",
        help="Run in headless mode: emit JSON draw commands to stdout for VS Code webview rendering."
    )
    ...
    if args.run:
        ...
        if args.headless:
            from headless_interpreter import HeadlessInterpreter
            inptr = HeadlessInterpreter(irHandler, args)
        else:       
